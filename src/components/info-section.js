  ...
  return (
    <section id="what" tabIndex="-1">
      <h2>What do I do?</h2>
        ...
        <p className="visuallyhidden">At any time, you can use the "Hear state of gane" link to get a reminder of all your past guesses and how close your current guess is to being correct.</p>
    </section>
  );
}
